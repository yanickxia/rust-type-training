...
#[cfg(test)]
mod tests {
    use crate::array::primitive_array::{F32Array, I32Array};
    use crate::array::string_array::StringArray;
    use super::*;
    ...
    #[test]
    fn test_build_float_array() {
        let data = vec![Some(1.0f32), Some(2.0f32), Some(3.0f32), None, Some(5.0f32)];
        let array = build_array_from_vec::<F32Array>(&data[..]);
        check_array_eq(&array, &data[..]);
    }
